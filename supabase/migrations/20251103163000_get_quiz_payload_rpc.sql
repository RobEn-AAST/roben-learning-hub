-- Fast path RPC: return quiz questions as a single JSON payload
-- Authorization: requires an existing quiz_attempt for (quiz_id, auth.uid())
-- Notes: intentionally excludes is_correct to avoid leaking answers
