  ...
  <div className="flex-1 w-full flex flex-col gap-20 items-center relative z-10 text-white">
        ...
        <div className="flex-1 flex flex-col gap-20 max-w-5xl p-5">
          ...
          <section className="w-full flex flex-col gap-8 mt-12">
            <h2 className="text-2xl font-bold text-white mb-4">About RobEn Learning Hub</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white/10 rounded-lg p-6 shadow-lg border border-blue-200/30">
                <h3 className="text-xl font-semibold text-yellow-200 mb-2">What is RobEn Learning Hub?</h3>
                <p className="text-white text-base">RobEn Learning Hub is a modern platform designed to empower learners and educators. It provides a seamless experience for managing courses, tracking progress, and engaging with interactive content.</p>
              </div>
              <div className="bg-white/10 rounded-lg p-6 shadow-lg border border-blue-200/30">
                <h3 className="text-xl font-semibold text-yellow-200 mb-2">Our Mission</h3>
                <p className="text-white text-base">Our mission is to make high-quality education accessible to everyone, everywhere. We believe in the power of technology to transform learning and help you control your future.</p>
              </div>
            </div>
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">Popular Courses</h2>
            <div className="flex items-center justify-between mb-2">
              <span></span>
              <a href="/courses">
                <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold py-2 px-4 rounded shadow transition">View All</button>
              </a>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white/10 rounded-lg p-6 shadow-lg border border-blue-200/30">
                <h4 className="text-lg font-semibold text-blue-200 mb-2">Introduction to Programming</h4>
                <p className="text-white text-base">Learn the basics of coding with hands-on projects and real-world examples. Perfect for beginners!</p>
              </div>
              <div className="bg-white/10 rounded-lg p-6 shadow-lg border border-blue-200/30">
                <h4 className="text-lg font-semibold text-blue-200 mb-2">Web Development Bootcamp</h4>
                <p className="text-white text-base">Build modern websites and applications using HTML, CSS, JavaScript, and React. No prior experience required.</p>
              </div>
              <div className="bg-white/10 rounded-lg p-6 shadow-lg border border-blue-200/30">
                <h4 className="text-lg font-semibold text-blue-200 mb-2">Data Science Essentials</h4>
                <p className="text-white text-base">Explore the world of data analysis, visualization, and machine learning with practical exercises and projects.</p>
              </div>
            </div>
          </section>
          {/* Top Instructors Section */}
          <section className="w-full flex flex-col gap-8 mt-12">
            <h2 className="text-2xl font-bold text-white mb-4">Our Top Instructors</h2>
            <div className="flex items-center justify-between mb-2">
              <span></span>
              <a href="/instructors">
                <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold py-2 px-4 rounded shadow transition">View All</button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white/10 rounded-lg p-6 shadow-lg border border-blue-200/30 flex flex-col items-center">
                ...
                <h4 className="text-lg font-semibold text-yellow-200 mb-1">Alex Johnson</h4>
                <p className="text-white text-base text-center">Expert in Web Development and JavaScript. Passionate about teaching and building real-world projects.</p>
              </div>
              <div className="bg-white/10 rounded-lg p-6 shadow-lg border border-blue-200/30 flex flex-col items-center">
                ...
                <h4 className="text-lg font-semibold text-yellow-200 mb-1">Sara Lee</h4>
                <p className="text-white text-base text-center">Data Scientist with 10+ years of experience. Loves making complex topics simple and fun.</p>
              </div>
              <div className="bg-white/10 rounded-lg p-6 shadow-lg border border-blue-200/30 flex flex-col items-center">
                ...
                <h4 className="text-lg font-semibold text-yellow-200 mb-1">Mohamed Ali</h4>
                <p className="text-white text-base text-center">Specialist in Python and AI. Focused on hands-on learning and student engagement.</p>
              </div>
            </div>
          </section>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-10 flex flex-col md:flex-row md:items-center md:justify-between gap-8">
          <div className="flex flex-col gap-2 items-start">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xl font-bold text-cyan-400 leading-tight">ROBEN<br />CLUB</span>
            </div>
